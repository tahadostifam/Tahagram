        ...
        <div class="messages_list">
          ...
          <div class="message_row" @contextmenu="show_contextmenu_of_message">
            <div class="message">
              <span class="sender_name">Username</span>
              <p class="message_content">
                Id sunt aliqua deserunt anim officia excepteur consequat nostrud
                eu non non officia consequat. In velit elit duis aliqua culpa
                cillum eu deserunt tempor voluptate esse Lorem. Nostrud velit
                fugiat officia esse fugiat eiusmod id proident non magna culpa.
                Sit do eiusmod dolore incididunt irure deserunt id officia non
                sunt dolor. Aliqua ut amet aute et enim et amet. Elit proident
                culpa culpa irure dolore. In magna commodo duis eu pariatur
                laboris qui. Elit dolor do nisi consequat dolore exercitation
                elit ad ullamco dolor in do esse. Sint Lorem nisi ut nisi ea
                irure irure officia. Culpa ullamco dolor anim irure nisi tempor
                tempor consequat adipisicing. Incididunt aliqua voluptate
                laborum deserunt ut est ex mollit anim irure occaecat elit nulla
              </p>
              <div class="message_footer">
                <!-- <span class="edit_state mr-1 font-italic">edited</span> -->
                <span class="send_datetime">1 Jan, 22:05</span>
      ...
      <div class="send_message_section">
        <div class="send_box">
          ...
          <emoji-picker class="emoji_picker" @emoji="insert">
            ...
            >
              <v-btn id="emojies_button" :color="theme_color" dark icon x-large>
          ...
          <v-btn
            ...
            x-large
          >
            <v-icon class="pl-1" small :color="theme_color"> mdi-send </v-icon>
          </v-btn>
        </div>
      </div>
    </div>
